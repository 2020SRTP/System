...
#define cSSC_OUT     1      	//Output pin for (SSC32 RX)
#define cSSC_IN      0     	//Input pin for (SSC32 TX)
...
// 机体尺寸单位mm
#define cRROffsetX      -40     // 从机体中心到右后 距离X
#define cRROffsetZ      75     //从机体中心到右后 距离Z
#define cRMOffsetX      -65     //从机体中心到右中 距离X
#define cRMOffsetZ      0       //从机体中心到右中 距离Z
#define cRFOffsetX      -40     //从机体中心到右前 距离X
#define cRFOffsetZ      -75     //从机体中心到右前 距离Z

#define cLROffsetX      40      //从机体中心到左后 距离X
#define cLROffsetZ      75      //从机体中心到左后 距离Z
#define cLMOffsetX      65      //从机体中心到左中 距离X
#define cLMOffsetZ      0       //从机体中心到左中 距离Z
#define cLFOffsetX      40      //从机体中心到左前 距离X
#define cLFOffsetZ      -75     //从机体中心到左前 距离Z

//--------------------------------------------------------------------
//[START POSITIONS FEET - 起始位置]
#define cHexInitXZ       200
#define CHexInitXZCos60  100    // cos(60) = 0.5
#define CHexInitXZSin60  173    // sin(60) = 0.866
#define CHexInitY        40
